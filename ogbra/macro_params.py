...
def get_macro_params(
    ...
    Args:
        ...
        update_from_api (bool): set True to pull updated data from World
            Bank, ILOSTAT, and IMF APIs
    ...
    if update_from_api:
        try:
            ...
            # Function to get the latest valid data if baseline_YYYYQ
            # is missing or NaN
    ...
    if update_from_api:
        ...
        discussion is here: https://github.com/PSLmodels/OG-BRA/issues/22
        Steps:
