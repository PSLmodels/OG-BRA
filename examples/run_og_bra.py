...
def main():
    ...
    save_dir = os.path.join(CUR_DIR, "OG-BRA-Example")
    ...
    op.plot_all(
        base_dir, reform_dir, os.path.join(save_dir, "OG-BRA_example_plots")
    )

    print("Percentage changes in aggregates:", ans)
    # save percentage change output to csv file
    ans.to_csv(os.path.join(save_dir, "OG-BRA_example_output.csv"))
