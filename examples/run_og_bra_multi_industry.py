...
def main():
    ...
    save_dir = os.path.join(CUR_DIR, "OG-BRA-MultiExample")
    ...
    op.plot_all(
        base_dir,
        reform_dir,
        os.path.join(save_dir, "OG-BRA_MultiExample_plots"),
    )

    print("Percentage changes in aggregates:", ans)
    # save percentage change output to csv file
    ans.to_csv(os.path.join(save_dir, "OG-BRA_MultiExample_output.csv"))
