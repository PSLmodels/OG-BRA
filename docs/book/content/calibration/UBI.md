...
[^GrowthAdj_note]: We impose this requirement of `ubi_growthadj = False` when `g_y_annual < 0` in the [`ogbra_default_parameters.json`](https://github.com/EAPD-DRB/OG-BRA/blob/master/ogbra/ogbra_default_parameters.json) "validators" specification of the parameter.
